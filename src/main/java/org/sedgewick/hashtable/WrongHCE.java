package org.sedgewick.hashtable;
 ...
 *    Describe what happens if you override hashCode() but implement public boolean equals(OlympicAthlete that) instead
 *      of public boolean equals(Object that).
 */
public class WrongHCE {
